...
class PerusahaanSettings(Base):
    ...
    email_invitation_subject = Column(String(255), default="[Pemberitahuan Resmi] Undangan Wawancara Video - {{job_title}} di {{company_name}}")
    ...
    email_hire_subject = Column(String(255), default="[Pemberitahuan Resmi] Penawaran Pekerjaan: Selamat Bergabung di {{company_name}}")
    ...
    email_reject_subject = Column(String(255), default="[Pemberitahuan Resmi] Pembaruan Status Lamaran - {{job_title}} di {{company_name}}")
    ...
    email_interview_user_subject = Column(String(255), default="[Pemberitahuan Resmi] Undangan Wawancara Lanjutan - {{job_title}} di {{company_name}}")
